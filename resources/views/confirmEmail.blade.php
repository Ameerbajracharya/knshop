										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		...
																		<tbody>
																			<tr>
																				...
																				<div class="contentEditable">
																					<p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;border-bottom: 1px solid black; padding-bottom: 5px;'>
																						<span class="specbundle2">
																							@if(isset($data['about']))
																							<span class="font1">{{$data['about']->name}}</span>
																							@else
																							<span class="font1">Kite Nepal</span>
																							@endif
																						</span>
																						</p>
																					</div>
											...
											<tr>
												<td valign='top' align='center'>
													...
													<div class="contentEditable">
														<img
														src="{{asset('public/images/logo/Logo.jpg')}}"
														width='251' height='43' alt=''
									...
									<td align='left'>
										...
										<div class="contentEditable" align='center'>
											...
											<h5 style="color: green; font-size: 20px;">
												Mr/Ms {{$confirm_mail->fullname}}</h5>
												<h6>Your Product Will be Delivered within 3-7 business days.</h6>
												<h5>Thank You for your business transaction with us. Hope for more supports and transaction in coming days.
													<span>Get more products at Affordable price.<a href="{{ route('frontend') }}">Here</a></span>
												</h5>
								...
								<tr>
									<td align='left'>
										...
										<div class="contentEditable" align='center'>
											<p>
												<br>
												Please Prefer the email or Call for
												assurance of the order.
												@if(isset($data['about']))
												<br>
												Email: {{$data['about']->email}}
												<br>
												Phone: {{$data['about']->contact}}
												@endif
											</p>
										</div>
									</div>
