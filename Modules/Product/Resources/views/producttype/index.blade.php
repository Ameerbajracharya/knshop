      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{Carbon\Carbon::parse($producttype->created_at)->diffForHumans()}}</td>
                ...
                @endif
                <td>
                    <a  class="btn btn-primary btn-sm" href="{{Route('producttype.edit',$producttype->id)}}"><i class="fa fa-edit" aria-hidden="true"></i>Edit</a>
                    <a  class="btn btn-danger btn-sm delete" href="{{Route('producttype.delete',$producttype->id)}}"><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
                </td>
            </tr>
            @endforeach
        </tbody>
