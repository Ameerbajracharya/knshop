								...
								<tr>
									<td align='left'>
										...
										<div class="contentEditable" align='center'>
											<p>
												Mr/Ms <b><u>{{$confirm_mail->fullname}}</u></b> has order <b><u>{{$confirm_mail->productname}}</u></b> of price <b><u>{{$confirm_mail->price}}</u></b>.<br>
												<span> 
													Please check <a href="{{route('dashboard')}}">Order</a> to know more.
												</span>
												<span>
													Thank you!
												</span>	
